...
<body>
    ...
    <td><input type="text" name="quantity" pattern="[0-9]+" title="accepts only numbers 0, 1, 2" required=""/>
</td>
    <td><input type="text" name="price" pattern="[0-9]+" title="accepts only numbers 0, 1, 2" required=""/> </td>
    <td><input type="submit" style="background-color: blue;color: white;border-color: white" name="update"></td>
   </form>
   <?php
