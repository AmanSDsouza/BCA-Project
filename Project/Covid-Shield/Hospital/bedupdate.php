...
<body>
    ...
    <td><input type="text" name="count" pattern="[0-9]+" title="accepts only numbers 0, 1, 2" required=""value="<?php echo $bedc; ?>"></td>
    <td><input type="submit" name="update" style="background-color: blue;color: white;border-color: white"></td>
   </form>
   <?php
