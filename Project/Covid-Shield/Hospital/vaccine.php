...
<body>
            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table class="table">
				  ...
				  <?php
	include("config.php");
	$sql1 = "select bookvaccine.*, hospital.hname from bookvaccine inner join hospital on hospital.email=bookvaccine.hemail where bookvaccine.hemail='".$_SESSION['huser']."'";
    ...
    <td><?php echo $status; ?></td>
     <td> <a href="vaccine.php?uid=<?php echo $id; ?>"><input type="submit" style="background-color: blue;color: white;border-color: white"></a></td>
   </tr>
   <?php }}?>
 </table>
 <?php 
 if(isset($_GET['uid']))
 {
	 $uid=$_GET['uid'];
	 include("config.php");
	$sql1 = "update bookvaccine set hstatus='Completed' where id='".$uid."'";
	$result1 = mysqli_query($con,$sql1);
