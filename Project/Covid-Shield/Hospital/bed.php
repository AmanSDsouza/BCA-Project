...
<body>
  ...
  <div class="col-lg-12">
    ...
    <td><img src="../user/uploads/<?php echo $img; ?>" style="height:80px;"></td>
    <td><?php echo $days; ?></td>
    <td><?php echo $date; ?></td>
    <td><?php echo $payment; ?></td>
    <td><?php echo $status; ?></td>
         <td> <a href="bed.php?uid=<?php echo $id; ?>"><input type="submit" value="Confirm" style="background-color: blue;color: white;border-color: white"></a></td>
   </tr>
	<?php }}?>
 </table>
 <?php 
