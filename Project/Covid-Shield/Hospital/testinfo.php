			 ...
			 ?>
					<form method="post" action="#">
						<div class="input-group">
							<input type="text" name="cost" pattern="[0-9]+" title="accepts only numbers 0, 1, 2" required="" value="<?php echo $cost; ?>" placeholder="Test Cost">
						</div><br>
						<div class="input-group">
							<input type="text" name="time" value="<?php echo $time; ?>" placeholder="Test Time">
						</div><br>
