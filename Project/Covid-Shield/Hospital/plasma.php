...
<body>
   ...
   <td><?php echo $name; ?></td>
    ...
    <td><?php if($status=='pending'){ ?><a href="plasmadet.php?uid=<?php echo $id; ?>"><input type="submit" value="Accept/Reject" style="background-color: blue;color: white;border-color: white"></a><?php } ?></td>
   </tr>
	<?php }} ?>
 </table>
