  ...
  <body>
   ...
   <?php include('nav.php'); ?>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item bread-item" style="background-image: url('images/qq.jpg');" data-stellar-background-ratio="0.5">
...
<section class="ftco-section" >
 ...
 <form action="#" class="box" method="post">
              ...
              <div class="form-group">
                <input placeholder="Date of Birth" type="date" name="dob" title="dob" max="<?php echo date("Y-m-d", strtotime("-6570 day"));?>" required="">
              </div>
	...
	<?php }}?>
                ...
                <div class="form-group">
  <input placeholder="Book Slot" type="date" name="slot" min="<?php echo date("Y-m-d", strtotime("+1 day"));?>"  required=""/>
</div>
