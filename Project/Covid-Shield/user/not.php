...
<?php
  ...
  <tr>
    ...
    if($report=='Positive')
    { ?>
    <td><center> <a href="images/pos.png" download="Positive">Download Certificate</a></center></td>
    <?php
    }
    else if($report=='Negative')
    { ?>
    <td> <center><a href="images/neg.png" download="Negative">Download Certificate</a></center></td>
    <?php
    }
    ?>
    <td><?php if($payment=='pending'){?><a href="payment.php?id=<?php echo $id; ?>&type=test&cost=<?php echo $cost ?>"><input type="submit" name="save" value="Pay" class="btn btn-primary py-3 px-5"></a><?php }?></td>
  </tr>
	<?php }}?>
  </table>
</center>
  ...
  <tr>
    ...
    <td>1000</td>
    <td><?php echo $payment; ?></td>
	<td><?php if($payment=='pending'){?><a href="payment.php?id=<?php echo $id; ?>&type=bed&cost=1000"><input type="submit" name="save" value="Pay" class="btn btn-primary py-3 px-5"></a><?php }?></td>
  </tr>
	<?php }}?>
  </table>
  </center>
  ...
  <tr>
	...
	<td><?php if($payment=='pending'){?><a href="payment.php?id=<?php echo $id; ?>&type=vaccine&cost=<?php echo $cost ?>"><input type="submit" name="save" value="Pay" class="btn btn-primary py-3 px-5"></a><?php }?></td>
   </tr>
	<?php }}?>
</table>
</center>
