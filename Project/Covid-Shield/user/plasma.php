...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item bread-item" style="background-image: url('images/bggg.jpg');" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container" data-scrollax-parent="true">
          <div class="row slider-text align-items-end">
            <div class="col-md-7 col-sm-12 ftco-animate mb-5">
              
              <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Thank you for the initiative</h1>
...
input[type=submit]:hover {
  ...
  <section class="ftco-section">
      ...
      <div class="form-group">
                <input type="text" class="form-control" placeholder="Donor Name" name="name" pattern="[A-Za-z\s]+" title="letters only" maxlength="50"required=""/>
              </div>
<div class="form-group">
                <input placeholder="Date of Birth" type="date" title="dob" name="dob" max="<?php echo date("Y-m-d", strtotime("-6570 day"));?>" required="">
              </div>
  <div class="form-group">
                <input type="number" name="age" class="form-control" placeholder="Age"required="" pattern="[0-9]+" title="numbers only" min="18" max="65" />
              </div>
<br>
<div class="form-group">
...
<div class="form-group">
    <input placeholder="Date of last symptom (approximate)" name="last" type="date" max="<?php echo date("Y-m-d", strtotime("-90 day"));?>" required="">
  </div>
  <center>
